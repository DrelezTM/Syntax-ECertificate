...
<head>
    ...
    <title>Syntax Certificates - Check Certificate via ID</title>
    ...
    <meta name="description" content="Syntax E-Certificate - Check Certificate via ID.">
...
<body class="bg-[#F0F3FF]" style="font-family: 'Inter';">
    ...
    <section class="pt-36 pb-10 md:px-16 px-10 h-screen flex justify-center items-center w-full">
        <div class="bg-white flex flex-col p-6 gap-5 w-full max-w-6xl mx-auto rounded-lg shadow-md">
            <h3 class="text-xl font-bold text-center">Search Certificate by ID</h3>
            <div class="flex flex-col gap-3">
                <div class="flex flex-col gap-2">
                    <label for="id">Certificate ID: <span class="text-red-600">*</span></label>
                    <input type="text" name="id" id="id" placeholder="Enter certificate id (eg: CERT01)" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:border-[#35448f]" required>
                </div>
                <button onclick="checkCertificate()" class="bg-[#35448e] text-white font-bold py-3 cursor-pointer px-6 rounded-lg shadow-lg border-2 border-[#35448e] hover:bg-[#435197] transition duration-300">VERIFY</button>
                <div class="flex w-full justify-center items-center">
                    <hr class="flex flex-1">
                    <p class="px-4 text-sm text-[#757575]">or</p>
                    <hr class="flex flex-1">
                </div>
                <p class="text-center text-[#757575]">You can also directly check the certificate by <a class="text-[#3a56e7] hover:text-[#2c42ad]" href={{ route('scan') }}>scanning the QR Code</a> for quick and easy verification.</p>
            </div>
        </div>
    </section>
